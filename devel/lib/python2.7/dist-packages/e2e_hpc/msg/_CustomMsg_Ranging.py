...
class CustomMsg_Ranging(genpy.Message):
  _md5sum = "1e4bb10cce0fbf9c437d573907658add"
...
float64 distance
"""
  __slots__ = ['ble_status','system_time','received_time','firstPath_power','aoa','distance']
  _slot_types = ['string','uint64','uint64','float64','float64','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       ble_status,system_time,received_time,firstPath_power,aoa,distance
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2Q3d().pack(_x.system_time, _x.received_time, _x.firstPath_power, _x.aoa, _x.distance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.system_time, _x.received_time, _x.firstPath_power, _x.aoa, _x.distance,) = _get_struct_2Q3d().unpack(str[start:end])
      return self
